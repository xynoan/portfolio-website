        ...
        <div className="relative min-h-screen w-full overflow-hidden bg-[#0a0a0a] text-white">
            ...
            <div className="container relative z-10 mx-auto px-4 py-16">
                ...
                <div className="mb-6 max-w-4xl mx-auto">
                    <p>Hey there 👋 I&#39;m 21 yrs old, currently in 3rd yr college. I&#39;ve taken interest in
                        programming since
                        March 2022, so that&#39;s 3 years now. Here&#39;s the timeline to better visualize my story
                        👇</p>
                </div>

                <div className="my-12 relative max-w-2xl mx-auto">
                    <div
                        className="hidden md:block absolute left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-purple-600 to-blue-400 transform -translate-x-1/2">
                    </div>
